        ...
        success: function (result) {
            ...
            if (result && result.length > 0) {
                for (let i = 0; i < result.length; i++) {
                    ...
                    clone.querySelector("[data-role=gericht]").innerHTML = result[i]['gericht'] + ((holidayDate) ? "":" <a target='menu_preview' href='https://www.google.com/search?tbm=isch&q=" + result[i]['gericht'] + "'>📷</a>");
